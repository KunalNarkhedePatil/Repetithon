...
int main()
{
    ...
    cout<<"main():Making use of objects 'd1_ksn' to make a call to Date::show()"<<endl;
    cout<<"main():Address of object 'd1_ksn' is "<<&d1_ksn<<endl;
    d1_ksn.show(); //== Date::show(&d1_ksn)//formal parameter will be 'this' pointer

    cout<<"main():Making use of objects 'd1_ksn' to make a call ro Date::show()"<<endl;
    ...
    cout<<"main():Address of objects 'd3_ksn' is"<<&d3_ksn<<endl;
