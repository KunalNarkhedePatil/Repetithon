...
int main(void)
{
    ...
    forceBetweenJupitorAndSun_ksn=jupitorSun_ksn.computeGravitational();

    std::cout<<"Force between the sun and the Earth is "<<forceBetweenEarthAndSun_ksn<< "Newton" <<std::endl;
    std::cout<<"Force between the sun and the jupitor is "<<forceBetweenJupitorAndSun_ksn<< "Newton" <<std::endl;
