...
int main(void)
{
    ...
    double G=6.67 * 10e-11;  /* universal constant of gravitatin*/
    ...
    printf("Enter the distance between the objects in meteres:");
    scanf("%lf",&r);
    ...
    printf("Gravitational force of attraction  = %lf Newtoons\n",F);
    return (0);
